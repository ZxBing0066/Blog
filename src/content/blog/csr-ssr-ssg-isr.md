---
title: 什么是 CSR、SSR、SSG、ISR
description: CSR、SSR、SSG、ISR 是目前前端非常常见的渲染模式。本文以 React、Vue 为例，介绍下主流的渲染模式以及在主流框架中如何实现上述的渲染模式。
pubDate: '2023-07-01'
heroImage: 'https://stg.heyfe.org/images/blog-csr-ssr-ssg-isr-1690811088700.webp'
tags:
    - 渲染模式
---
